...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/blog/will-ai-replace-graphic-designers`, lastModified: now, changeFrequency: 'yearly', priority: 0.8 },
    { url: `${base}/blog/the-real-cost-of-an-ai-generated-logo`, lastModified: now, changeFrequency: 'yearly', priority: 0.8 },
    { url: `${base}/blog/signs-your-website-is-costing-you-clients`, lastModified: now, changeFrequency: 'yearly', priority: 0.8 },
