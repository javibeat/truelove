...
const translations = {
  en: {
    ...
    // Artists Page
    'artists.hero1': 'Your Sound Deserves',
    'artists.hero2': 'a Visual Identity.',
    'artists.heroSub': 'We build brands for DJs, musicians, and performers in Dubai. From your website to your stage visuals — we make you look as good as you sound.',
    'artists.storyLabel': 'The Story',
    'artists.story1': 'We come from <span class="highlight">the music world</span>. Before designing for artists, we were one.',
    'artists.story2': 'Javi Beat — founder of TRUE LOVE CREATIVE — has been part of the Dubai music scene for over a decade. As a DJ, he understands what artists need: not just a website, but a complete visual identity that translates the energy of your sound into design.',
    'artists.story3': 'That\'s why the artists we work with don\'t get generic templates. They get brands built by someone who knows the industry from the inside.',
    'artists.servicesTitle': 'WHAT WE BUILD FOR ARTISTS',
    'artists.svc1.title': 'Artist Websites & EPK',
    'artists.svc1.desc': 'Your digital home. Bio, music, tour dates, press kit — everything a booker or fan needs, in one place.',
    'artists.svc2.title': 'Brand Identity & Logo',
    'artists.svc2.desc': 'A logo and visual system that captures your sound. From typography to color palette — your brand, defined.',
    'artists.svc3.title': 'Social Media Kits',
    'artists.svc3.desc': 'Templates for Instagram, TikTok, YouTube. Consistent visuals that make every post look intentional.',
    'artists.svc4.title': 'Press Kits & Promo',
    'artists.svc4.desc': 'Professional press materials that get you booked. One-sheets, rider templates, and promotional decks.',
    'artists.svc5.title': 'Album & Single Artwork',
    'artists.svc5.desc': 'Cover art that stops the scroll. Designed for Spotify, Beatport, vinyl — every format, every platform.',
    'artists.portfolioTitle': 'ARTISTS WE\'VE WORKED WITH',
    'artists.javi.role': 'DJ & Producer',
    'artists.javi.desc': 'Personal brand and website for DJ and producer based in Dubai for over a decade.',
    'artists.kiko.role': 'DJ & Producer',
    'artists.kiko.desc': 'Website, visual identity, and vinyl cover design for the legendary Ibiza-born house music artist.',
    'artists.manu.role': 'Saxophonist',
    'artists.manu.desc': 'Personal brand and booking platform for Dubai\'s premier luxury saxophonist.',
    'artists.sergio.role': 'Trumpet & DJ',
    'artists.sergio.desc': 'Portfolio and brand identity for the dynamic trumpet player and DJ performer.',
    'artists.julio.role': 'Violinist',
    'artists.julio.desc': 'Visual identity and artistic portfolio for a world-class violinist performer.',
    'artists.quote': '"They understood my sound before I even explained it. The brand they built feels exactly like my music looks — if music could look like something."',
    'artists.quoteAuthor': '— Artist, Dubai',
    'artists.num1': 'Artists Branded',
    'artists.num2': 'Years in Dubai Music Scene',
    'artists.num3': 'Built with Love',
    'artists.cta': 'READY TO ELEVATE YOUR BRAND?',
  ...
  es: {
    ...
    // Artists Page
    'artists.hero1': 'Tu Sonido Merece',
    'artists.hero2': 'una Identidad Visual.',
    'artists.heroSub': 'Creamos marcas para DJs, músicos y artistas en Dubai. Desde tu web hasta tus visuales — hacemos que te veas tan bien como suenas.',
    'artists.storyLabel': 'La Historia',
    'artists.story1': 'Venimos del <span class="highlight">mundo de la música</span>. Antes de diseñar para artistas, fuimos uno.',
    'artists.story2': 'Javi Beat — fundador de TRUE LOVE CREATIVE — lleva más de una década en la escena musical de Dubai. Como DJ, entiende lo que los artistas necesitan: no solo una web, sino una identidad visual completa que traduzca la energía de tu sonido en diseño.',
    'artists.story3': 'Por eso los artistas con los que trabajamos no reciben plantillas genéricas. Reciben marcas creadas por alguien que conoce la industria desde dentro.',
    'artists.servicesTitle': 'LO QUE CREAMOS PARA ARTISTAS',
    'artists.svc1.title': 'Webs de Artista & EPK',
    'artists.svc1.desc': 'Tu casa digital. Bio, música, fechas de gira, press kit — todo lo que un booker o fan necesita, en un solo lugar.',
    'artists.svc2.title': 'Identidad de Marca & Logo',
    'artists.svc2.desc': 'Un logo y sistema visual que captura tu sonido. Tipografía, paleta de colores — tu marca, definida.',
    'artists.svc3.title': 'Kits para Redes Sociales',
    'artists.svc3.desc': 'Plantillas para Instagram, TikTok, YouTube. Visuales consistentes que hacen que cada post se vea intencional.',
    'artists.svc4.title': 'Press Kits & Promo',
    'artists.svc4.desc': 'Materiales de prensa profesionales que te consiguen bookings. One-sheets, riders y decks promocionales.',
    'artists.svc5.title': 'Artwork de Álbum & Single',
    'artists.svc5.desc': 'Portadas que paran el scroll. Diseñadas para Spotify, Beatport, vinilo — cada formato, cada plataforma.',
    'artists.portfolioTitle': 'ARTISTAS CON LOS QUE HEMOS TRABAJADO',
    'artists.javi.role': 'DJ & Productor',
    'artists.javi.desc': 'Marca personal y web para DJ y productor en Dubai desde hace más de una década.',
    'artists.kiko.role': 'DJ & Productor',
    'artists.kiko.desc': 'Web, identidad visual y diseño de portada de vinilo para el legendario artista de house nacido en Ibiza.',
    'artists.manu.role': 'Saxofonista',
    'artists.manu.desc': 'Marca personal y plataforma de booking para el saxofonista de lujo de Dubai.',
    'artists.sergio.role': 'Trompeta & DJ',
    'artists.sergio.desc': 'Portfolio e identidad de marca para el dinámico trompetista y DJ performer.',
    'artists.julio.role': 'Violinista',
    'artists.julio.desc': 'Identidad visual y portfolio artístico para un violinista de talla mundial.',
    'artists.quote': '"Entendieron mi sonido antes de que lo explicara. La marca que construyeron se siente exactamente como se ve mi música — si la música pudiera verse."',
    'artists.quoteAuthor': '— Artista, Dubai',
    'artists.num1': 'Artistas con Marca',
    'artists.num2': 'Años en la Escena Musical de Dubai',
    'artists.num3': 'Hecho con Amor',
    'artists.cta': '¿LISTO PARA ELEVAR TU MARCA?',
